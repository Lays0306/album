                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="form-group mt-2">
                                            <div class="custom-file"> <input type="file" class="custom-file-input"
                                                    ...
                                                    for="customFile">Nenhum arquivo selecionado</label> </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group"> <label for="textarea">Descrição</label> <textarea
                                            id="textarea" name="textarea" cols="40" rows="5" class="form-control"
